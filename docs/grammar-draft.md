...
[#48](https://github.com/JustVugg/tinllm/issues/48), implementation in
[#70](https://github.com/JustVugg/tinllm/pull/70), consolidated write-up with A/B
measurements and corrections in [#146](https://github.com/JustVugg/tinllm/issues/146).*
...
The umbrella idea is not tinllm's: **jump-forward decoding** (SGLang;
