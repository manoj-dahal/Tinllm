...
| `convert` | Convert an FP8 repo to a TinLLM int4 snapshot. |
...
| `--port` | `8000` | Port. |
| `--model-id` | `$COLI_MODEL_ID` or `glm-5.2-tinllm` | Model id reported by the API. |
...
| `--host` | `127.0.0.1` | Bind address. |
| `--port` | `8000` | Port. |
| `--model-id` | `$COLI_MODEL_ID` or `glm-5.2-tinllm` | Model id in API responses. |
