...
Why this exists
---------------
Measuring "what does int4 cost us?" by comparing tinllm's score to a published model-card
...
through tinllm's OWN quantizer (quantize -> dequantize, in place), and scores both with the
...
# --------------------------------------------------------------------------------------
# tinllm's quantizer (tools/convert_fp8_to_int4.py:32-52), generalised with a group size.
#
