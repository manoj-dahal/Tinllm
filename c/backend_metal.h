#ifndef TINLLM_BACKEND_METAL_H
#define TINLLM_BACKEND_METAL_H
...
/*
 * Apple-GPU (Metal) backend for TinLLM. Apple Silicon has one GPU and unified
 ...
 */
void coli_metal_spin_start(void);   /* TIN_METAL_SPIN=1 keep-alive experiment */
